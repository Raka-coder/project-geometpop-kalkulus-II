...
const questions: Question[] = [
  {
    id: 1,
    type: 'calculation',
    text: 'Sebuah kota berpenduduk 20,000 orang dan mengalami pertumbuhan populasi sebesar 4% per tahun. Berapa jumlah penduduk setelah 5 tahun?',
    options: ['21,000 orang', '24,333 orang', '26,000 orang', '24,000 orang'],
    correctAnswer: 1,
    explanation:
      'Menggunakan rumus pertumbuhan populasi geometrik dengan pertumbuhan persentase:',
    formula:
      'P_n = P_0 \\times (1 + r)^n = 20,000 \\times (1 + 0.04)^5 = 24,333',
  },
  {
    id: 2,
    type: 'theory',
              ...
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <CardDescription className="text-gray-600">
                    Uji pemahaman Anda tentang model pertumbuhan geometrik
                    ...
                    >
                      <div className="space-y-3">
                        ...
                        {questions[currentQuestion].formula && (
                          <div className="p-3 bg-custom-gray/50 rounded-md overflow-y-auto md:overflow-auto">
                            <MathRenderer
              ...
              {!quizCompleted && (
                <>
                  <Button
                    variant="outline"
                    onClick={handleRestartQuiz}
                    className="border-dark-blue text-dark-blue hover:bg-gray-50 sm:w-auto w-full md:w-auto font-medium"
                  >
                    Mulai Ulang
                  </Button>
                  <div className="sm:flex sm:flex-row sm:items-center sm:gap-3">
                    {answeredQuestions.includes(currentQuestion) ? (
                      ...
                      <Button
                        ...
                        className="bg-custom-yellow text-dark-blue hover:bg-custom-yellow/90 w-full md:w-auto font-medium"
                      >
                        Periksa Jawaban
                      </Button>
                    )}
