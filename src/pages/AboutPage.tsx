          ...
          <div className="max-w-4xl mx-auto">
                ...
                <CardContent className="p-6">
                  ...
                  <div className="bg-dark-blue/5 p-4 rounded-lg mb-6 text-center">
                    <p className="text-sm font-bold text-dark-blue">
                      <MathRenderer type="block" formula="a + ar + ar^2 + ar^3 + \dots + ar^{(n-1)}" />
                    </p>
                  </div>
                  ...
                  <ul className="list-disc pl-6 mb-4 space-y-2 text-gray-700">
                    ...
                    <li className="flex items-center gap-2">
                      <MathRenderer type="inline" formula="r" />= rasio umum (common ratio)
                    </li>
                    <li className="flex items-center gap-2">
                  ...
                  <div className="bg-dark-blue/5 p-4 rounded-lg mb-6 flex flex-col items-center justify-center gap-4">
                    <p className="text-sm font-bold text-dark-blue">
                      <MathRenderer type="inline" formula="S_n = \frac{a(1 - r^n)}{1 - r}, \text{ untuk } r \neq 1" />
                    </p>
                    <p className="text-sm font-bold text-dark-blue">
                      <MathRenderer type="inline" formula="S_n = na, \text{ untuk } r = 1" />
                    </p>
                  </div>
                </CardContent>
              </Card>
              ...
              <CardContent className="p-6">
                ...
                <div className="bg-dark-blue/5 p-4 rounded-lg mb-6 gap-4 flex flex-col items-center justify-center">
                  <p className="text-center text-sm font-bold text-dark-blue">
                    <MathRenderer type="inline" formula="S_\infty = \frac{a}{1 - r}, \text{ untuk } |r| < 1" />
                  </p>
                  <p className="text-center text-sm font-bold text-dark-blue">
                    <MathRenderer type="inline" formula="S_\infty = \infty, \text{ untuk } |r| \geq 1" />
                  </p>
                </div>
                <p className="text-gray-700 mb-4">
            ...
            <Card className="mb-8">
              <CardContent className="p-6">
                ...
                <div className="bg-dark-blue/5 p-4 rounded-lg mb-6 flex flex-col items-center justify-center gap-4">
                  <p className="text-center text-sm font-bold text-dark-blue">
                    <MathRenderer type="inline" formula="P(t) = P_0 \times (1 + r)^t" />
                  </p>
                </div>
                <p className="text-gray-700 mb-4">
                ...
                <div className="bg-dark-blue/5 p-4 rounded-lg mb-6 flex flex-col items-center justify-center gap-4">
                  <p className="text-center text-sm font-bold text-dark-blue">
                    <MathRenderer type="inline" formula="P(t+1) = P(t) + r \times P(t) \times (1 - \frac{P(t)}{K})" />
                  </p>
                </div>
                <p className="text-gray-700 mb-4">
