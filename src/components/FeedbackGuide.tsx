      ...
      <div className="space-y-4">
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-gray-600">
              Untuk bug, sertakan langkah-langkah atau alurnya dengan jelas.
              Untuk fitur baru, jelaskan manfaat dan use case-nya.
            </p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-gray-600">
              Jelaskan situasi atau masalah yang ingin Anda selesaikan dengan
              feedback ini.
            </p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-gray-600">
              Semua feedback akan dibaca oleh tim. Kami menghargai bahasa yang
