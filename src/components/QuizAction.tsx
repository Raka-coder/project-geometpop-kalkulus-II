...
import { Timer, Calculator, ChartNoAxesColumnIncreasing, Trophy, RocketIcon  } from "lucide-react"
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="p-8 md:p-10 flex flex-col justify-center">
            <h2 className="text-3xl font-bold text-dark-blue mb-4">
              Uji Pemahamanmu Tentang <span className="text-custom-yellow">Pemodelan Populasi</span>
            </h2>
            
            <p className="text-lg text-gray-600 mb-6">
              Jelajahi konsep deret geometri melalui kuis interaktif kami. 
              Temukan seberapa dalam pemahamanmu tentang pertumbuhan dan penurunan populasi!
            </p>
            ...
            >
                <Link to="/quiz">Mulai Kuis Sekarang<RocketIcon className="mr-2 h-5 w-5" /></Link>
            </Button>
          </div>
            ...
            <div className="relative h-full flex items-center justify-center p-8">
              <div className="bg-white p-6 rounded-lg shadow-md max-w-xs">
                ...
                <p className="text-gray-700 mb-3">
                  Jika populasi meningkat 30% per tahun, berapa rasio pertumbuhan (r) dalam model geometrik?
                </p>
                <div className="space-y-2">
                  <div className="px-3 py-2 bg-green-50 rounded-md border border-green-200">
                    <p className="text-sm font-medium text-green-700">r = 1.3</p>
                  </div>
