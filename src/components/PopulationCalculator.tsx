...
const PopulationCalculator = () => {
  ...
  const [useCarryingCapacity, setUseCarryingCapacity] = useState<boolean>(false);
  ...
  const calculatePopulation = () => {
    ...
    setTotalIndividuals(calculateFiniteGeometricSum(initialPopulation, commonRatio, periods + 1));
    
    // Calculate infinite sum (long-term population) if applicable
    setInfiniteSum(calculateInfiniteGeometricSum(initialPopulation, commonRatio));
        ...
        <TabsContent value="calculator" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Masukkan nilai untuk menghitung pertumbuhan populasi berdasarkan deret geometri
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    step="1"
                  />
                  <p className="text-sm text-muted-foreground">Jumlah individu pada awal periode</p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center space-x-2">
                    <Input
                      ...
                      className="flex-1"
                    />
                    <span className="w-10 text-center">{(growthRate * 100).toFixed(0)}%</span>
                  </div>
                  <p className="text-sm text-muted-foreground">Rasio pertumbuhan per periode (desimal)</p>
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">Jumlah interval waktu untuk disimulasikan</p>
              </div>
              ...
              <div className="flex items-center space-x-3 pt-2">
                ...
                />
                <Label htmlFor="use-carrying-capacity">Gunakan Daya Dukung Lingkungan</Label>
              </div>
              ...
              {useCarryingCapacity && (
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    step="10"
                  />
                  <p className="text-sm text-muted-foreground">Kapasitas maksimum populasi yang dapat didukung oleh lingkungan</p>
                </div>
              )}
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Visualisasi pertumbuhan populasi berdasarkan parameter yang dimasukkan</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <PopulationChart 
                populationData={populationData} 
                carryingCapacity={useCarryingCapacity ? carryingCapacity : undefined} 
              />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mt-4">
                <Card>
                  ...
                  <CardContent>
                    <p className="text-2xl font-bold text-dark-blue">{formatNumber(initialPopulation)}</p>
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent>
                    <p className="text-2xl font-bold text-dark-blue">{formatNumber(finalPopulation)}</p>
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent>
                    <p className="text-2xl font-bold text-custom-yellow">{formatNumber(finalPopulation - initialPopulation)}</p>
                    <p className="text-sm text-muted-foreground">
                      {((finalPopulation / initialPopulation - 1) * 100).toFixed(2)}%
                    </p>
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent>
                    <p className="text-2xl font-bold text-dark-blue">{periods}</p>
                  </CardContent>
                </Card>
              </div>
            </CardContent>
        ...
        <TabsContent value="analysis" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Informasi tambahan dan analisis mendalam berdasarkan parameter model
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <h3 className="text-lg font-semibold border-l-4 border-custom-yellow pl-3">Waktu Penggandaan</h3>
                  <p className="text-sm">
                    Waktu yang dibutuhkan untuk populasi menjadi dua kali lipat dari ukuran awalnya.
                  </p>
                  <div className="bg-gray-50 p-4 rounded-md">
                    {growthRate > 0 ? (
                      <>
                        <p className="text-xl font-bold text-dark-blue">{doublingTime.toFixed(2)} periode</p>
                        <p className="text-sm text-muted-foreground">
                          Dengan tingkat pertumbuhan {(growthRate * 100).toFixed(2)}% per periode
                        </p>
                      </>
                    ) : (
                      <p className="text-red-500">Populasi tidak tumbuh (tingkat pertumbuhan ≤ 0)</p>
                    )}
                  </div>
                  
                  <h3 className="text-lg font-semibold border-l-4 border-custom-yellow pl-3 mt-6">Waktu Untuk Mencapai Target</h3>
                  {growthRate > 0 ? (
                    <div className="space-y-2">
                      <p className="text-sm">
                        Berapa periode yang dibutuhkan untuk mencapai populasi 10 kali lipat dari populasi awal:
                      </p>
                      <div className="bg-gray-50 p-4 rounded-md">
                        <p className="text-xl font-bold text-dark-blue">
                          {calculateTimeToReachPopulation(initialPopulation, initialPopulation * 10, growthRate)} periode
                        </p>
                      </div>
                    </div>
                  ) : (
                    <p className="text-sm text-red-500">
                      Tidak dapat menghitung waktu pencapaian dengan tingkat pertumbuhan ≤ 0
                    </p>
                  )}
                </div>
                
                <div className="space-y-4">
                  <h3 className="text-lg font-semibold border-l-4 border-custom-yellow pl-3">Total Individu Selama Periode</h3>
                  <p className="text-sm">
                    Total individu yang ada selama semua periode (jumlah dari semua periode). 
                  ...
                  {infiniteSum !== null ? (
                    <>
                      <p className="text-sm">
                        Untuk rasio pertumbuhan |r| &lt; 1, jumlah deret geometri tak hingga:
                      </p>
                      <div className="bg-gray-50 p-4 rounded-md">
                        <p className="text-xl font-bold text-dark-blue">{formatNumber(infiniteSum)}</p>
                        <p className="text-sm text-muted-foreground">
                          S<sub>∞</sub> = a/(1-r) = {initialPopulation}/(1-({(growthRate).toFixed(2)}))
                        </p>
                      </div>
                    </>
                  ) : (
                    <div className="bg-gray-50 p-4 rounded-md">
                      <p className="text-red-500">
                        Deret divergen (jumlah tak hingga tidak terhingga) karena |r| ≥ 1
                      </p>
                      <p className="text-sm text-muted-foreground">
                        Dengan tingkat pertumbuhan {(growthRate * 100).toFixed(2)}%, populasi akan terus bertambah tanpa batas
                      </p>
                    </div>
                  )}
                </div>
              ...
              <Card className="bg-dark-blue/5 border-custom-yellow mt-4">
                <CardHeader className="py-3">
                  <CardTitle className="text-dark-blue text-lg">Penjelasan Model</CardTitle>
                </CardHeader>
                <CardContent>
                  ...
                  {useCarryingCapacity ? (
                    ...
                    <p className="text-sm mb-3">
                      <span className="font-semibold">Keterbatasan:</span> Model dasar tanpa daya dukung dapat menghasilkan 
                      pertumbuhan tak terbatas yang tidak realistis dalam jangka panjang. Aktifkan "Daya Dukung Lingkungan" 
